 ...
 */
package com.l2jolivia.gameserver.network;

import java.nio.ByteBuffer;
import java.util.logging.Logger;

import com.l2jolivia.Config;
import com.l2jolivia.commons.mmocore.IClientFactory;
import com.l2jolivia.commons.mmocore.IMMOExecutor;
import com.l2jolivia.commons.mmocore.IPacketHandler;
import com.l2jolivia.commons.mmocore.MMOConnection;
import com.l2jolivia.commons.mmocore.ReceivablePacket;
import com.l2jolivia.gameserver.network.L2GameClient.GameClientState;
import com.l2jolivia.gameserver.network.clientpackets.*;
import com.l2jolivia.gameserver.network.clientpackets.adenadistribution.RequestDivideAdena;
import com.l2jolivia.gameserver.network.clientpackets.adenadistribution.RequestDivideAdenaCancel;
import com.l2jolivia.gameserver.network.clientpackets.adenadistribution.RequestDivideAdenaStart;
import com.l2jolivia.gameserver.network.clientpackets.alchemy.RequestAlchemyConversion;
import com.l2jolivia.gameserver.network.clientpackets.alchemy.RequestAlchemySkillList;
import com.l2jolivia.gameserver.network.clientpackets.alchemy.RequestAlchemyTryMixCube;
import com.l2jolivia.gameserver.network.clientpackets.appearance.RequestExCancelShape_Shifting_Item;
import com.l2jolivia.gameserver.network.clientpackets.appearance.RequestExTryToPutShapeShiftingEnchantSupportItem;
import com.l2jolivia.gameserver.network.clientpackets.appearance.RequestExTryToPutShapeShiftingTargetItem;
import com.l2jolivia.gameserver.network.clientpackets.appearance.RequestShapeShiftingItem;
import com.l2jolivia.gameserver.network.clientpackets.commission.RequestCommissionBuyInfo;
import com.l2jolivia.gameserver.network.clientpackets.commission.RequestCommissionBuyItem;
import com.l2jolivia.gameserver.network.clientpackets.commission.RequestCommissionCancel;
import com.l2jolivia.gameserver.network.clientpackets.commission.RequestCommissionDelete;
import com.l2jolivia.gameserver.network.clientpackets.commission.RequestCommissionInfo;
import com.l2jolivia.gameserver.network.clientpackets.commission.RequestCommissionList;
import com.l2jolivia.gameserver.network.clientpackets.commission.RequestCommissionRegister;
import com.l2jolivia.gameserver.network.clientpackets.commission.RequestCommissionRegisteredItem;
import com.l2jolivia.gameserver.network.clientpackets.commission.RequestCommissionRegistrableItemList;
import com.l2jolivia.gameserver.network.clientpackets.compound.RequestNewEnchantClose;
import com.l2jolivia.gameserver.network.clientpackets.compound.RequestNewEnchantPushOne;
import com.l2jolivia.gameserver.network.clientpackets.compound.RequestNewEnchantPushTwo;
import com.l2jolivia.gameserver.network.clientpackets.compound.RequestNewEnchantRemoveOne;
import com.l2jolivia.gameserver.network.clientpackets.compound.RequestNewEnchantRemoveTwo;
import com.l2jolivia.gameserver.network.clientpackets.compound.RequestNewEnchantTry;
import com.l2jolivia.gameserver.network.clientpackets.crystalization.RequestCrystallizeEstimate;
import com.l2jolivia.gameserver.network.clientpackets.crystalization.RequestCrystallizeItemCancel;
import com.l2jolivia.gameserver.network.clientpackets.dailymission.RequestOneDayRewardReceive;
import com.l2jolivia.gameserver.network.clientpackets.dailymission.RequestTodoList;
import com.l2jolivia.gameserver.network.clientpackets.dailymission.RequestTodoListHTML;
import com.l2jolivia.gameserver.network.clientpackets.ensoul.RequestItemEnsoul;
import com.l2jolivia.gameserver.network.clientpackets.friend.RequestAnswerFriendInvite;
import com.l2jolivia.gameserver.network.clientpackets.friend.RequestFriendDel;
import com.l2jolivia.gameserver.network.clientpackets.friend.RequestFriendDetailInfo;
import com.l2jolivia.gameserver.network.clientpackets.friend.RequestFriendInvite;
import com.l2jolivia.gameserver.network.clientpackets.friend.RequestFriendList;
import com.l2jolivia.gameserver.network.clientpackets.friend.RequestSendFriendMsg;
import com.l2jolivia.gameserver.network.clientpackets.friend.RequestUpdateBlockMemo;
import com.l2jolivia.gameserver.network.clientpackets.friend.RequestUpdateFriendMemo;
import com.l2jolivia.gameserver.network.clientpackets.luckygame.RequestLuckyGamePlay;
import com.l2jolivia.gameserver.network.clientpackets.mentoring.ConfirmMenteeAdd;
import com.l2jolivia.gameserver.network.clientpackets.mentoring.RequestMenteeAdd;
import com.l2jolivia.gameserver.network.clientpackets.mentoring.RequestMenteeWaitingList;
import com.l2jolivia.gameserver.network.clientpackets.mentoring.RequestMentorCancel;
import com.l2jolivia.gameserver.network.clientpackets.mentoring.RequestMentorList;
import com.l2jolivia.gameserver.network.clientpackets.primeshop.RequestBRBuyProduct;
import com.l2jolivia.gameserver.network.clientpackets.primeshop.RequestBRGamePoint;
import com.l2jolivia.gameserver.network.clientpackets.primeshop.RequestBRProductInfo;
import com.l2jolivia.gameserver.network.clientpackets.primeshop.RequestBRProductList;
import com.l2jolivia.gameserver.network.clientpackets.primeshop.RequestBRRecentProductList;
import com.l2jolivia.gameserver.network.clientpackets.shuttle.CannotMoveAnymoreInShuttle;
import com.l2jolivia.gameserver.network.clientpackets.shuttle.MoveToLocationInShuttle;
import com.l2jolivia.gameserver.network.clientpackets.shuttle.RequestShuttleGetOff;
import com.l2jolivia.gameserver.network.clientpackets.shuttle.RequestShuttleGetOn;
