...
import com.l2jolivia.gameserver.model.actor.instance.L2TrapInstance;
import com.l2jolivia.gameserver.model.actor.templates.L2NpcTemplate;
import com.l2jolivia.gameserver.model.drops.GeneralDropItem;
import com.l2jolivia.gameserver.model.drops.GroupedGeneralDropItem;
import com.l2jolivia.gameserver.model.drops.IDropItem;
...
import com.l2jolivia.gameserver.model.events.annotations.Id;
import com.l2jolivia.gameserver.model.events.annotations.Ids;
import com.l2jolivia.gameserver.model.events.annotations.NpcLevelRange;
import com.l2jolivia.gameserver.model.events.annotations.NpcLevelRanges;
import com.l2jolivia.gameserver.model.events.annotations.Priority;
import com.l2jolivia.gameserver.model.events.annotations.Range;
import com.l2jolivia.gameserver.model.events.annotations.Ranges;
...
import com.l2jolivia.gameserver.model.events.listeners.AbstractEventListener;
import com.l2jolivia.gameserver.model.events.listeners.AnnotationEventListener;
import com.l2jolivia.gameserver.model.events.listeners.ConsumerEventListener;
import com.l2jolivia.gameserver.model.events.listeners.DummyEventListener;
import com.l2jolivia.gameserver.model.events.listeners.FunctionEventListener;
import com.l2jolivia.gameserver.model.events.listeners.RunnableEventListener;
import com.l2jolivia.gameserver.model.events.returns.AbstractEventReturn;
...
import com.l2jolivia.gameserver.model.interfaces.INamable;
import com.l2jolivia.gameserver.model.interfaces.IPositionable;
...
import com.l2jolivia.gameserver.network.serverpackets.SpecialCamera;
...
import com.l2jolivia.gameserver.scripting.ScriptManager;
import com.l2jolivia.gameserver.util.MinionList;
...
public abstract class AbstractScript implements INamable
{
	...
	/**
	 * Provides instant callback operation when {@link com.l2jolivia.gameserver.model.actor.L2Character} Enters on a {@link L2ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link com.l2jolivia.gameserver.model.actor.L2Character} Exits on a {@link L2ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link com.l2jolivia.gameserver.model.actor.instance.L2TrapInstance} acts.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	 ...
	 * Use this method instead of importing {@link com.l2jolivia.util.Rnd} utility.
	...
	/**
	 * @return the number of ticks from the {@link com.l2jolivia.gameserver.GameTimeController}.
	 */
