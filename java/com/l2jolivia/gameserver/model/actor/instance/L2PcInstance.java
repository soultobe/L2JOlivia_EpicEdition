...
import com.l2jolivia.gameserver.GeoData;
import com.l2jolivia.gameserver.ItemsAutoDestroy;
import com.l2jolivia.gameserver.LoginServerThread;
import com.l2jolivia.gameserver.RecipeController;
...
import com.l2jolivia.gameserver.ai.L2PlayerAI;
import com.l2jolivia.gameserver.ai.L2SummonAI;
import com.l2jolivia.gameserver.cache.WarehouseCacheManager;
import com.l2jolivia.gameserver.communitybbs.BB.Forum;
import com.l2jolivia.gameserver.communitybbs.Manager.ForumsBBSManager;
import com.l2jolivia.gameserver.data.sql.impl.CharNameTable;
import com.l2jolivia.gameserver.data.sql.impl.CharSummonTable;
import com.l2jolivia.gameserver.data.sql.impl.ClanTable;
import com.l2jolivia.gameserver.data.xml.impl.AdminData;
import com.l2jolivia.gameserver.data.xml.impl.ClassListData;
import com.l2jolivia.gameserver.data.xml.impl.EnchantSkillGroupsData;
import com.l2jolivia.gameserver.data.xml.impl.ExperienceData;
import com.l2jolivia.gameserver.data.xml.impl.FishData;
import com.l2jolivia.gameserver.data.xml.impl.HennaData;
import com.l2jolivia.gameserver.data.xml.impl.NpcData;
import com.l2jolivia.gameserver.data.xml.impl.PetDataTable;
import com.l2jolivia.gameserver.data.xml.impl.PlayerTemplateData;
import com.l2jolivia.gameserver.data.xml.impl.PlayerXpPercentLostData;
import com.l2jolivia.gameserver.data.xml.impl.RecipeData;
import com.l2jolivia.gameserver.data.xml.impl.SkillTreesData;
import com.l2jolivia.gameserver.datatables.ItemTable;
import com.l2jolivia.gameserver.datatables.SkillData;
import com.l2jolivia.gameserver.enums.CastleSide;
import com.l2jolivia.gameserver.enums.CategoryType;
import com.l2jolivia.gameserver.enums.ChatType;
import com.l2jolivia.gameserver.enums.DuelState;
import com.l2jolivia.gameserver.enums.HtmlActionScope;
import com.l2jolivia.gameserver.enums.IllegalActionPunishmentType;
import com.l2jolivia.gameserver.enums.InstanceType;
import com.l2jolivia.gameserver.enums.MountType;
import com.l2jolivia.gameserver.enums.PartyDistributionType;
import com.l2jolivia.gameserver.enums.PartySmallWindowUpdateType;
import com.l2jolivia.gameserver.enums.PlayerAction;
import com.l2jolivia.gameserver.enums.PrivateStoreType;
import com.l2jolivia.gameserver.enums.Race;
import com.l2jolivia.gameserver.enums.Sex;
import com.l2jolivia.gameserver.enums.ShortcutType;
import com.l2jolivia.gameserver.enums.ShotType;
import com.l2jolivia.gameserver.enums.SubclassInfoType;
import com.l2jolivia.gameserver.enums.Team;
import com.l2jolivia.gameserver.enums.UserInfoType;
import com.l2jolivia.gameserver.handler.IItemHandler;
import com.l2jolivia.gameserver.handler.ItemHandler;
import com.l2jolivia.gameserver.idfactory.IdFactory;
import com.l2jolivia.gameserver.instancemanager.AntiFeedManager;
import com.l2jolivia.gameserver.instancemanager.CastleManager;
import com.l2jolivia.gameserver.instancemanager.CoupleManager;
import com.l2jolivia.gameserver.instancemanager.CursedWeaponsManager;
import com.l2jolivia.gameserver.instancemanager.DuelManager;
...
import com.l2jolivia.gameserver.instancemanager.GrandBossManager;
import com.l2jolivia.gameserver.instancemanager.HandysBlockCheckerManager;
import com.l2jolivia.gameserver.instancemanager.InstanceManager;
import com.l2jolivia.gameserver.instancemanager.ItemsOnGroundManager;
import com.l2jolivia.gameserver.instancemanager.MentorManager;
import com.l2jolivia.gameserver.instancemanager.PremiumManager;
import com.l2jolivia.gameserver.instancemanager.PunishmentManager;
import com.l2jolivia.gameserver.instancemanager.QuestManager;
import com.l2jolivia.gameserver.instancemanager.SiegeManager;
import com.l2jolivia.gameserver.instancemanager.ZoneManager;
import com.l2jolivia.gameserver.model.ArenaParticipantsHolder;
import com.l2jolivia.gameserver.model.BlockList;
import com.l2jolivia.gameserver.model.ClanPrivilege;
import com.l2jolivia.gameserver.model.L2AccessLevel;
import com.l2jolivia.gameserver.model.L2Clan;
import com.l2jolivia.gameserver.model.L2ClanMember;
import com.l2jolivia.gameserver.model.L2ContactList;
import com.l2jolivia.gameserver.model.L2EnchantSkillLearn;
import com.l2jolivia.gameserver.model.L2ManufactureItem;
import com.l2jolivia.gameserver.model.L2Object;
import com.l2jolivia.gameserver.model.L2Party;
import com.l2jolivia.gameserver.model.L2Party.messageType;
import com.l2jolivia.gameserver.model.L2PetLevelData;
import com.l2jolivia.gameserver.model.L2PremiumItem;
import com.l2jolivia.gameserver.model.L2Radar;
import com.l2jolivia.gameserver.model.L2RecipeList;
import com.l2jolivia.gameserver.model.L2Request;
import com.l2jolivia.gameserver.model.L2SkillLearn;
import com.l2jolivia.gameserver.model.L2World;
import com.l2jolivia.gameserver.model.L2WorldRegion;
import com.l2jolivia.gameserver.model.Location;
import com.l2jolivia.gameserver.model.Macro;
import com.l2jolivia.gameserver.model.MacroList;
import com.l2jolivia.gameserver.model.PartyMatchRoom;
import com.l2jolivia.gameserver.model.PartyMatchRoomList;
import com.l2jolivia.gameserver.model.PartyMatchWaitingList;
import com.l2jolivia.gameserver.model.PcCondOverride;
import com.l2jolivia.gameserver.model.ShortCuts;
import com.l2jolivia.gameserver.model.Shortcut;
import com.l2jolivia.gameserver.model.TeleportBookmark;
import com.l2jolivia.gameserver.model.TeleportWhereType;
import com.l2jolivia.gameserver.model.TimeStamp;
import com.l2jolivia.gameserver.model.TradeList;
import com.l2jolivia.gameserver.model.UIKeysSettings;
import com.l2jolivia.gameserver.model.actor.L2Attackable;
import com.l2jolivia.gameserver.model.actor.L2Character;
import com.l2jolivia.gameserver.model.actor.L2Decoy;
import com.l2jolivia.gameserver.model.actor.L2Npc;
import com.l2jolivia.gameserver.model.actor.L2Playable;
import com.l2jolivia.gameserver.model.actor.L2Summon;
import com.l2jolivia.gameserver.model.actor.L2Vehicle;
import com.l2jolivia.gameserver.model.actor.appearance.PcAppearance;
import com.l2jolivia.gameserver.model.actor.knownlist.PcKnownList;
import com.l2jolivia.gameserver.model.actor.request.AbstractRequest;
import com.l2jolivia.gameserver.model.actor.stat.PcStat;
import com.l2jolivia.gameserver.model.actor.status.PcStatus;
import com.l2jolivia.gameserver.model.actor.tasks.player.DismountTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.FameTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.GameGuardCheckTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.InventoryEnableTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.LookingForFishTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.PetFeedTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.PvPFlagTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.RecoGiveTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.RentPetTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.ResetChargesTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.ResetSoulsTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.SitDownTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.StandUpTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.TeleportWatchdogTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.WarnUserTakeBreakTask;
import com.l2jolivia.gameserver.model.actor.tasks.player.WaterTask;
import com.l2jolivia.gameserver.model.actor.templates.L2PcTemplate;
import com.l2jolivia.gameserver.model.actor.transform.Transform;
import com.l2jolivia.gameserver.model.base.ClassId;
import com.l2jolivia.gameserver.model.base.ClassLevel;
import com.l2jolivia.gameserver.model.base.PlayerClass;
import com.l2jolivia.gameserver.model.base.SubClass;
...
import com.l2jolivia.gameserver.model.entity.Duel;
import com.l2jolivia.gameserver.model.entity.Fort;
import com.l2jolivia.gameserver.model.entity.Friend;
import com.l2jolivia.gameserver.model.entity.Hero;
import com.l2jolivia.gameserver.model.entity.Instance;
import com.l2jolivia.gameserver.model.entity.L2Event;
import com.l2jolivia.gameserver.model.entity.Siege;
import com.l2jolivia.gameserver.model.entity.TvTEvent;
import com.l2jolivia.gameserver.model.events.EventDispatcher;
import com.l2jolivia.gameserver.model.events.impl.character.npc.OnNpcSocialActionSee;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerEquipItem;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerFameChanged;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerHennaAdd;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerHennaRemove;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerKarmaChanged;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerLogin;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerLogout;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerPKChanged;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerProfessionChange;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerPvPChanged;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerPvPKill;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerRaidPointsChanged;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerSubChange;
import com.l2jolivia.gameserver.model.events.impl.character.player.OnPlayerTransform;
import com.l2jolivia.gameserver.model.events.impl.character.player.mentoring.OnPlayerMenteeStatus;
import com.l2jolivia.gameserver.model.events.impl.character.player.mentoring.OnPlayerMentorStatus;
import com.l2jolivia.gameserver.model.fishing.L2Fish;
import com.l2jolivia.gameserver.model.fishing.L2Fishing;
import com.l2jolivia.gameserver.model.holders.AdditionalSkillHolder;
import com.l2jolivia.gameserver.model.holders.ItemHolder;
import com.l2jolivia.gameserver.model.holders.PlayerEventHolder;
import com.l2jolivia.gameserver.model.holders.SkillHolder;
import com.l2jolivia.gameserver.model.holders.SkillUseHolder;
import com.l2jolivia.gameserver.model.interfaces.IEventListener;
import com.l2jolivia.gameserver.model.interfaces.ILocational;
...
import com.l2jolivia.gameserver.model.itemcontainer.PcFreight;
import com.l2jolivia.gameserver.model.itemcontainer.PcInventory;
import com.l2jolivia.gameserver.model.itemcontainer.PcRefund;
import com.l2jolivia.gameserver.model.itemcontainer.PcWarehouse;
import com.l2jolivia.gameserver.model.itemcontainer.PetInventory;
import com.l2jolivia.gameserver.model.items.L2Armor;
import com.l2jolivia.gameserver.model.items.L2EtcItem;
import com.l2jolivia.gameserver.model.items.L2Henna;
import com.l2jolivia.gameserver.model.items.L2Item;
import com.l2jolivia.gameserver.model.items.L2Weapon;
import com.l2jolivia.gameserver.model.items.instance.L2ItemInstance;
import com.l2jolivia.gameserver.model.items.type.ActionType;
import com.l2jolivia.gameserver.model.items.type.ArmorType;
import com.l2jolivia.gameserver.model.items.type.EtcItemType;
import com.l2jolivia.gameserver.model.items.type.WeaponType;
import com.l2jolivia.gameserver.model.multisell.PreparedListContainer;
import com.l2jolivia.gameserver.model.olympiad.OlympiadGameManager;
import com.l2jolivia.gameserver.model.olympiad.OlympiadGameTask;
import com.l2jolivia.gameserver.model.olympiad.OlympiadManager;
import com.l2jolivia.gameserver.model.punishment.PunishmentAffect;
import com.l2jolivia.gameserver.model.punishment.PunishmentType;
import com.l2jolivia.gameserver.model.quest.Quest;
import com.l2jolivia.gameserver.model.quest.QuestState;
import com.l2jolivia.gameserver.model.skills.AbnormalType;
import com.l2jolivia.gameserver.model.skills.BuffInfo;
import com.l2jolivia.gameserver.model.skills.CommonSkill;
import com.l2jolivia.gameserver.model.skills.Skill;
import com.l2jolivia.gameserver.model.skills.targets.L2TargetType;
import com.l2jolivia.gameserver.model.stats.Formulas;
import com.l2jolivia.gameserver.model.stats.Stats;
import com.l2jolivia.gameserver.model.variables.AccountVariables;
import com.l2jolivia.gameserver.model.variables.PlayerVariables;
import com.l2jolivia.gameserver.model.zone.L2ZoneType;
import com.l2jolivia.gameserver.model.zone.ZoneId;
import com.l2jolivia.gameserver.model.zone.type.L2BossZone;
import com.l2jolivia.gameserver.network.L2GameClient;
import com.l2jolivia.gameserver.network.SystemMessageId;
import com.l2jolivia.gameserver.network.serverpackets.AbstractHtmlPacket;
import com.l2jolivia.gameserver.network.serverpackets.ActionFailed;
import com.l2jolivia.gameserver.network.serverpackets.ChangeWaitType;
import com.l2jolivia.gameserver.network.serverpackets.CharInfo;
import com.l2jolivia.gameserver.network.serverpackets.ConfirmDlg;
import com.l2jolivia.gameserver.network.serverpackets.EtcStatusUpdate;
import com.l2jolivia.gameserver.network.serverpackets.ExAbnormalStatusUpdateFromTarget;
import com.l2jolivia.gameserver.network.serverpackets.ExAcquireAPSkillList;
import com.l2jolivia.gameserver.network.serverpackets.ExAdenaInvenCount;
import com.l2jolivia.gameserver.network.serverpackets.ExAutoSoulShot;
import com.l2jolivia.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import com.l2jolivia.gameserver.network.serverpackets.ExFishingEnd;
import com.l2jolivia.gameserver.network.serverpackets.ExFishingStart;
import com.l2jolivia.gameserver.network.serverpackets.ExGetBookMarkInfoPacket;
import com.l2jolivia.gameserver.network.serverpackets.ExGetOnAirShip;
import com.l2jolivia.gameserver.network.serverpackets.ExMagicAttackInfo;
import com.l2jolivia.gameserver.network.serverpackets.ExNewSkillToLearnByLevelUp;
import com.l2jolivia.gameserver.network.serverpackets.ExOlympiadMode;
import com.l2jolivia.gameserver.network.serverpackets.ExPledgeCount;
import com.l2jolivia.gameserver.network.serverpackets.ExPrivateStoreSetWholeMsg;
import com.l2jolivia.gameserver.network.serverpackets.ExSetCompassZoneCode;
import com.l2jolivia.gameserver.network.serverpackets.ExStartScenePlayer;
import com.l2jolivia.gameserver.network.serverpackets.ExStorageMaxCount;
import com.l2jolivia.gameserver.network.serverpackets.ExSubjobInfo;
import com.l2jolivia.gameserver.network.serverpackets.ExUseSharedGroupItem;
import com.l2jolivia.gameserver.network.serverpackets.ExUserInfoAbnormalVisualEffect;
...
import com.l2jolivia.gameserver.network.serverpackets.FlyToLocation.FlyType;
import com.l2jolivia.gameserver.network.serverpackets.GameGuardQuery;
import com.l2jolivia.gameserver.network.serverpackets.GetOnVehicle;
import com.l2jolivia.gameserver.network.serverpackets.HennaInfo;
...
import com.l2jolivia.gameserver.network.serverpackets.LeaveWorld;
import com.l2jolivia.gameserver.network.serverpackets.MagicSkillUse;
import com.l2jolivia.gameserver.network.serverpackets.MyTargetSelected;
import com.l2jolivia.gameserver.network.serverpackets.NicknameChanged;
import com.l2jolivia.gameserver.network.serverpackets.ObservationMode;
import com.l2jolivia.gameserver.network.serverpackets.ObservationReturn;
import com.l2jolivia.gameserver.network.serverpackets.PartySmallWindowUpdate;
import com.l2jolivia.gameserver.network.serverpackets.PetInventoryUpdate;
import com.l2jolivia.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import com.l2jolivia.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import com.l2jolivia.gameserver.network.serverpackets.PrivateStoreListBuy;
import com.l2jolivia.gameserver.network.serverpackets.PrivateStoreListSell;
import com.l2jolivia.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import com.l2jolivia.gameserver.network.serverpackets.PrivateStoreManageListSell;
import com.l2jolivia.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import com.l2jolivia.gameserver.network.serverpackets.PrivateStoreMsgSell;
import com.l2jolivia.gameserver.network.serverpackets.RecipeShopMsg;
import com.l2jolivia.gameserver.network.serverpackets.RecipeShopSellList;
import com.l2jolivia.gameserver.network.serverpackets.RelationChanged;
import com.l2jolivia.gameserver.network.serverpackets.Ride;
import com.l2jolivia.gameserver.network.serverpackets.ServerClose;
import com.l2jolivia.gameserver.network.serverpackets.SetupGauge;
import com.l2jolivia.gameserver.network.serverpackets.ShortCutInit;
import com.l2jolivia.gameserver.network.serverpackets.SkillCoolTime;
import com.l2jolivia.gameserver.network.serverpackets.SkillList;
import com.l2jolivia.gameserver.network.serverpackets.Snoop;
import com.l2jolivia.gameserver.network.serverpackets.SocialAction;
import com.l2jolivia.gameserver.network.serverpackets.StatusUpdate;
import com.l2jolivia.gameserver.network.serverpackets.StopMove;
import com.l2jolivia.gameserver.network.serverpackets.SystemMessage;
import com.l2jolivia.gameserver.network.serverpackets.TargetSelected;
import com.l2jolivia.gameserver.network.serverpackets.TargetUnselected;
import com.l2jolivia.gameserver.network.serverpackets.TradeDone;
import com.l2jolivia.gameserver.network.serverpackets.TradeOtherDone;
import com.l2jolivia.gameserver.network.serverpackets.TradeStart;
import com.l2jolivia.gameserver.network.serverpackets.UserInfo;
import com.l2jolivia.gameserver.network.serverpackets.ValidateLocation;
import com.l2jolivia.gameserver.network.serverpackets.commission.ExResponseCommissionInfo;
import com.l2jolivia.gameserver.network.serverpackets.friend.L2FriendStatus;
import com.l2jolivia.gameserver.taskmanager.AttackStanceTaskManager;
import com.l2jolivia.gameserver.util.Broadcast;
import com.l2jolivia.gameserver.util.FloodProtectors;
import com.l2jolivia.gameserver.util.Util;
import com.l2jolivia.util.EnumIntBitmask;
