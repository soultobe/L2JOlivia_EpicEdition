...
import com.l2jolivia.gameserver.network.serverpackets.ExAskModifyPartyLooting;
import com.l2jolivia.gameserver.network.serverpackets.ExCloseMPCC;
import com.l2jolivia.gameserver.network.serverpackets.ExOpenMPCC;
...
import com.l2jolivia.gameserver.network.serverpackets.ExSetPartyLooting;
import com.l2jolivia.gameserver.network.serverpackets.ExTacticalSign;
import com.l2jolivia.gameserver.network.serverpackets.L2GameServerPacket;
import com.l2jolivia.gameserver.network.serverpackets.PartyMemberPosition;
import com.l2jolivia.gameserver.network.serverpackets.PartySmallWindowAdd;
import com.l2jolivia.gameserver.network.serverpackets.PartySmallWindowAll;
import com.l2jolivia.gameserver.network.serverpackets.PartySmallWindowDelete;
import com.l2jolivia.gameserver.network.serverpackets.PartySmallWindowDeleteAll;
...
public class L2Party extends AbstractPlayerGroup
{
	 ...
	 * @see com.l2jolivia.gameserver.model.actor.instance.L2PcInstance#isRequestExpired()
	 */
